	...
	public function VerPerfilSecretariaC(){
		...
		echo '<tr>
				...
				if($resultado["foto"] != ""){
					...
					echo '<td><img src="http://localhost/citas_medicas/'.$resultado["foto"].'" class="img-responsive" width="40px"></td>';

				}else{

					echo '<td><img src="http://localhost/citas_medicas/Vistas/img/paty.png" class="img-responsive" width="40px"></td>';
				...
				echo '<td>
					...
					<a href="http://localhost/citas_medicas/perfil-S/'.$resultado["id"].'">
				...
				<div class="row">
					...
					<h2>Genero:</h2>
						...
						if($resultado["foto"] == ""){
							...
							echo '<img src="http://localhost/citas_medicas/Vistas/img/paty.png" width="200px;">';
	...
	public function ActualizarPerfilSecretariaC(){
		...
		if(isset($_POST["idP"])){
			...
			if($resultado == true){
				...
				window.location = "http://localhost/citas_medicas/perfil-Secretaria/'.$_SESSION["id"].'";
				</script>';
